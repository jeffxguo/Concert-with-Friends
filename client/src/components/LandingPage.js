        ...
        <div>
            <div style={{
                ...
                <div style={{ backgroundColor: "#171717", height: "80vh", width: "26vw", minWidth: 500, padding: "4em 6em 4em 2em", marginRight: "10%" }}>
                    <div style={{ color: "white", fontSize: "3.4em", fontWeight: 700, textAlign: "left" }}><span style={{ color: COLORS.pink }}>CONCERTS</span> ARE BETTER WITH <span style={{ color: COLORS.pink }}>FRIENDS</span></div>
            ...
            <div style={{ display: "flex", flexDirection: "row", margin: " 4em 10%" }}>
                <div style={{ flex: 2, fontSize: "2.4em", textAlign: "left", fontWeight: "700", margin: "1em 1em 0 0" }}>
